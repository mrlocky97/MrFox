...
public class PrincipalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nombre = (EditText)vista.findViewById(R.id.etNombreLogin);
        contraseña = (EditText)vista.findViewById(R.id.etPasswordLogin);
        login = (Button)vista.findViewById(R.id.btnEmpezarLogin);
        registrarse = (Button)vista.findViewById(R.id.btnRegistroLogin);

        login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity) getActivity()).pantallaFox();
            }
        });
